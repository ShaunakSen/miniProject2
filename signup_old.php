...
<div class="container">
    <form name="sign up form" action="signup.php" onsubmit="return false;" class="myForm" id = "myForm">
        <br><br><br>
        ...
        <input type="number" id="year" disabled class="admission-year" name="year" min="2011" max="2015" onblur="run()">
        <br><br>
        ...
        <input type="password" class="input" id="password" name="password" placeholder="Enter Password" disabled onblur="stupid('password')">
        <br><br>
        ...
        <button class="submit" id="submit" onclick="signup()" disabled>Submit</button>
        <br><br>
        <div id="status"></div>
